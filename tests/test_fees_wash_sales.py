...
class TestFeeTracking:
    ...
    def test_tax_transaction_includes_sell_fee(self):
        ...
        trades = [
            _make_trade(
                timestamp=datetime(2024, 1, 1), type="Buy", price=0.50, shares=10, cost=5.0, fee=0.0
            ),
            _make_trade(
                timestamp=datetime(2024, 6, 1),
                type="Sell",
...
class TestWashSaleDetection:
    ...
    def test_no_wash_sales_key_when_none(self):
        ...
        trades = [
            ...
            _make_trade(
                timestamp=datetime(2024, 6, 1), type="Sell", price=0.70, shares=10, cost=7.0
            ),
        ]
        result = calculate_capital_gains(trades, tax_year=2024)
        assert "wash_sales" not in result
...
class TestDataCompleteness:
    ...
    def test_total_trades_in_scope(self):
        ...
        trades = [
            ...
            _make_trade(timestamp=datetime(2024, 3, 1), type="Buy", price=0.60, shares=5, cost=3.0),
            _make_trade(
                timestamp=datetime(2024, 6, 1), type="Sell", price=0.70, shares=10, cost=7.0
            ),
        ]
    ...
    def test_excess_sell_logs_warning(self, caplog):
        ...
        trades = [
            _make_trade(timestamp=datetime(2024, 1, 1), type="Buy", price=0.50, shares=5, cost=2.5),
            _make_trade(
                timestamp=datetime(2024, 6, 1), type="Sell", price=0.70, shares=10, cost=7.0
            ),
        ]
    ...
    def test_total_trades_includes_all_years(self):
        ...
        trades = [
            _make_trade(
                timestamp=datetime(2023, 1, 1), type="Buy", price=0.50, shares=10, cost=5.0
            ),
            _make_trade(
                timestamp=datetime(2024, 6, 1), type="Sell", price=0.70, shares=10, cost=7.0
            ),
