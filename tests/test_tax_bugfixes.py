...
class TestPriorYearSellsConsumeLots:
    ...
    def test_fifo_prior_year_sell_consumes_earliest_lot(self):
        ...
        trades = [
            _make_trade(
                timestamp=datetime(2023, 1, 15), type="Buy", price=0.30, shares=10, cost=3.0
            ),
            _make_trade(
                timestamp=datetime(2023, 6, 15), type="Buy", price=0.70, shares=10, cost=7.0
            ),
            _make_trade(
                timestamp=datetime(2023, 12, 1), type="Sell", price=0.90, shares=10, cost=9.0
            ),
            _make_trade(
                timestamp=datetime(2024, 3, 1), type="Sell", price=0.50, shares=10, cost=5.0
            ),
        ]
    ...
    def test_average_prior_year_sell_reduces_pool(self):
        ...
        trades = [
            _make_trade(
                timestamp=datetime(2023, 1, 15), type="Buy", price=0.40, shares=10, cost=4.0
            ),
            _make_trade(
                timestamp=datetime(2023, 6, 15), type="Buy", price=0.60, shares=10, cost=6.0
            ),
            _make_trade(
                timestamp=datetime(2023, 12, 1), type="Sell", price=0.80, shares=10, cost=8.0
            ),
            _make_trade(
                timestamp=datetime(2024, 3, 1), type="Sell", price=0.70, shares=10, cost=7.0
            ),
        ]
    ...
    def test_no_transactions_outside_tax_year(self):
        ...
        trades = [
            _make_trade(
                timestamp=datetime(2023, 1, 15), type="Buy", price=0.50, shares=10, cost=5.0
            ),
            _make_trade(
                timestamp=datetime(2023, 12, 1), type="Sell", price=0.80, shares=10, cost=8.0
            ),
    ...
    def test_prior_year_sell_prevents_double_counting(self):
        ...
        trades = [
            _make_trade(
                timestamp=datetime(2023, 1, 15), type="Buy", price=0.50, shares=100, cost=50.0
            ),
            # Sell ALL 100 shares in 2023
            _make_trade(
                timestamp=datetime(2023, 6, 1), type="Sell", price=0.80, shares=100, cost=80.0
            ),
            # Try to sell 50 more in 2024 — no lots should remain
            _make_trade(
                timestamp=datetime(2024, 3, 1), type="Sell", price=0.60, shares=50, cost=30.0
            ),
        ]
    ...
    def test_partial_prior_year_sell(self):
        ...
        trades = [
            _make_trade(
                timestamp=datetime(2023, 1, 15), type="Buy", price=0.40, shares=100, cost=40.0
            ),
            # Sell 30 of 100 in 2023
            _make_trade(
                timestamp=datetime(2023, 6, 1), type="Sell", price=0.70, shares=30, cost=21.0
            ),
            # Sell 70 in 2024
            _make_trade(
                timestamp=datetime(2024, 3, 1), type="Sell", price=0.60, shares=70, cost=42.0
            ),
        ]
...
class TestYearBoundaryPrecision:
    ...
    def test_trade_at_midnight_jan1_same_year_included(self):
        ...
        trades = [
            _make_trade(
                timestamp=datetime(2023, 6, 1), type="Buy", price=0.50, shares=10, cost=5.0
            ),
            _make_trade(
...
class TestHoldingPeriodClassification:
    ...
    def test_exactly_365_days_is_long_term(self):
        ...
        trades = [
            _make_trade(
                timestamp=datetime(2023, 3, 1), type="Buy", price=0.50, shares=10, cost=5.0
            ),
            _make_trade(
                timestamp=datetime(2024, 2, 29),
                type="Sell",  # 365 days later (2024 is leap year)
                price=0.80,
                shares=10,
                cost=8.0,
            ),
    ...
    def test_364_days_is_short_term(self):
        ...
        trades = [
            _make_trade(
                timestamp=datetime(2023, 3, 2), type="Buy", price=0.50, shares=10, cost=5.0
            ),
            _make_trade(
                timestamp=datetime(2024, 2, 29),
                type="Sell",  # 364 days
    ...
    def test_short_and_long_term_separation(self):
        ...
        trades = [
            ...
            _make_trade(
                timestamp=datetime(2022, 6, 1), type="Buy", price=0.30, shares=10, cost=3.0
            ),
            # Short-term lot: bought < 365 days before sell
            _make_trade(
                timestamp=datetime(2024, 1, 15), type="Buy", price=0.60, shares=10, cost=6.0
            ),
            # Sell all 20 shares
            _make_trade(
                timestamp=datetime(2024, 6, 1), type="Sell", price=0.80, shares=20, cost=16.0
            ),
        ]
...
class TestCostBasisMethods:
    ...
    def three_lot_trades(self):
        ...
        return [
            _make_trade(
                timestamp=datetime(2024, 1, 1), type="Buy", price=0.30, shares=10, cost=3.0
            ),
            _make_trade(
                timestamp=datetime(2024, 2, 1), type="Buy", price=0.50, shares=10, cost=5.0
            ),
            _make_trade(
                timestamp=datetime(2024, 3, 1), type="Buy", price=0.70, shares=10, cost=7.0
            ),
            _make_trade(
                timestamp=datetime(2024, 6, 1), type="Sell", price=0.60, shares=30, cost=18.0
            ),
        ]
    ...
    def test_average_uses_weighted_mean(self, three_lot_trades):
        result = calculate_capital_gains(
            three_lot_trades, tax_year=2024, cost_basis_method="average"
        )
